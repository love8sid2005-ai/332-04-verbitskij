...
if (!defined('DB_PATH')) {
    define('DB_PATH', PROJECT_ROOT . '/storage/database/database.db');
}
...
function validatePassword($password) {
    ...
    if (!preg_match('/[a-zA-Zа-яА-Я]/', $password)) {
...
function getSecretQuestions() {
    return [
        ...
        'first_pet' => 'Имя первого питомца',
        'birth_city' => 'Город рождения',
        'favorite_teacher' => 'Имя любимого учителя',
        'childhood_friend' => 'Имя друга детства'
    ];
}

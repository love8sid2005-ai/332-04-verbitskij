...
class PasswordValidationTest extends TestCase
{
    ...
    /**
     * Тест: валидный пароль password123
     */
    public function testValidPassword123(): void
    {
    ...
    /**
     * Тест: валидный пароль с русскими буквами
     */
    public function testValidPasswordWithRussianLetters(): void
    {
        $password = 'Тест1234';
        $result = validatePassword($password);
        $this->assertTrue($result['valid'], 'Пароль с русскими буквами должен быть валидным');
    }
    
    /**
     * Тест: валидный пароль длиной более 8 символов
     */
    public function testValidPasswordLong(): void
    {
        $password = 'Test123456';
        $result = validatePassword($password);
        $this->assertTrue($result['valid'], 'Пароль длиной более 8 символов должен быть валидным');
    }
